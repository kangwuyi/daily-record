...
(function () {
    ...
    var a = {
      ...
      domReady: function () {
        ...
        return function (d) {
          ...
          if (1 == f.length)if (document.addEventListener)document.addEventListener("DOMContentLoaded", a, !1), window.addEventListener("load", a, !1); else if (document.attachEvent) {
  ...
  CKEDITOR.event || (CKEDITOR.event = function () {
    ...
    b.prototype = {
      getListenerIndex: function (a) {
        for (var d = 0, f = this.listeners; d < f.length; d++)if (f[d].fn == a)return d;
        return -1
      }
    };
    return {
      define: function (b, d) {
        ...
        function i(a, o, s, r) {
          a = {name: b, sender: this, editor: a, data: o, listenerData: e, stop: s, cancel: r, removeListener: k};
        ...
        if (o.getListenerIndex(d) < 0) {
          ...
          i.fn = d;
          i.priority = n;
          for (var r = o.length - 1; r >= 0; r--)if (o[r].priority <= n) {
            o.splice(r + 1, 0, i);
      ...
      once: function () {
        ...
        return function (n, i, k) {
          var o = e(this)[n], n = a, s = f;
          a = f = 0;
          if (o) {
            var r = o.listeners;
            if (r.length)for (var r = r.slice(0), v, g = 0; g < r.length; g++) {
              if (o.errorProof)try {
                v = r[g].call(this,
                  k, i, d, b)
              } catch (p) {
              } else v = r[g].call(this, k, i, d, b);
  ...
  CKEDITOR.dom = {};
  (function () {
    var a = [], e = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, d = /</g, f = /"/g, h = /&amp;/g, n = /&gt;/g, i = /&lt;/g, k = /&quot;/g;
    ...
    CKEDITOR.tools = {
      arrayCompare: function (a, d) {
        ...
        for (var f = 0; f < a.length; f++)if (a[f] != d[f])return false;
        return true
      }, clone: function (a) {
        var d;
        ...
        var d = arguments.length, f, b;
        if (typeof(f = arguments[d - 1]) == "boolean")d--; else if (typeof(f = arguments[d - 2]) == "boolean") {
          b = arguments[d - 1];
          d = d - 2
        }
        for (var g = 1; g < d; g++) {
          var e =
            arguments[g], c;
          for (c in e)if (f === true || a[c] == void 0)if (!b || c in b)a[c] = e[c]
        }
        return a
        ...
        var a =
          document.createElement("div").style, d = typeof a.cssFloat != "undefined" ? "cssFloat" : typeof a.styleFloat != "undefined" ? "styleFloat" : "float";
        return function (a) {
        ...
        for (var a = [].concat(a), d, f = [], b = 0; b < a.length; b++)if (d = a[b])/@import|[{}]/.test(d) ? f.push("<style>" + d + "</style>") : f.push('<link type="text/css" rel=stylesheet href="' + d + '">');
        return f.join("")
        ...
        if (typeof d == "function")for (var f = 0, b = a.length; f < b; f++) {
          if (d(a[f]))return f
        } else {
          if (a.indexOf)return a.indexOf(d);
          f = 0;
          for (b = a.length; f < b; f++)if (a[f] === d)return f
        }
        return -1
      }, search: function (a, d) {
        ...
        var d = a.$, f = a.base, b = a.privates || a._, g = a.proto, a = a.statics;
        !d && (d = function () {
          f && this.base.apply(this, arguments)
        });
        if (b)var e = d, d = function () {
        ...
        var f = [], b, g = CKEDITOR.tools.parseCssText(a, true, d);
        ...
        if (!f)for (b in d)if (a[b] != d[b])return false;
        return true
        ...
        for (var f = ["abbr", "article", "aside", "audio", "bdi", "canvas", "data",
          "datalist", "details", "figcaption", "figure", "footer", "header", "hgroup", "mark", "meter", "nav", "output", "progress", "section", "summary", "time", "video"], b = f.length, g; b--;) {
          g = a.createElement(f[b]);
          d && a.appendChild(g)
        }
      }, checkIfAnyArrayItemMatches: function (a, d) {
        for (var f = 0, b = a.length; f < b; ++f)if (a[f].match(d))return true;
        return false
      }, checkIfAnyObjectPropertyMatches: function (a, d) {
        for (var f in a)if (f.match(d))return true;
        return false
  ...
  CKEDITOR.dtd = function () {
    var a = CKEDITOR.tools.extend, e = function (a, d) {
      ...
      table: 1,
      ul: 1
    }, f = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, n = {"#": 1}, i = {
      center: 1,
      dir: 1,
      noframes: 1
    };
  ...
  (function (a) {
    ...
    a.removeCustomData = function (a) {
      var c = this.$["data-cke-expando"], c = c && e[c], d, f;
      if (c) {
        d = c[a];
        f = a in c;
        delete c[a]
    ...
    appendTo: function (a, e) {
      ...
      var b = this.$.cloneNode(a), c = function (d) {
        ...
        if (d.nodeType == CKEDITOR.NODE_ELEMENT) {
          ...
          if (a)for (var d = d.childNodes, f = 0; f < d.length; f++)c(d[f])
        }
      };
      c(b);
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
    type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
      ...
      for (var b = this.$.documentElement, c =
        0; b && c < a.length; c++) {
        var d = a[c];
        if (e)for (var f = -1, h = 0; h < b.childNodes.length; h++) {
  ...
  CKEDITOR.dom.element.setMarker = function (a, e, b, c) {
    var d = e.getCustomData("list_marker_id") || e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"), f = e.getCustomData("list_marker_names") || e.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
    a[d] = e;
    f[b] = 1;
  ...
  CKEDITOR.dom.element.clearMarkers = function (a, e, b) {
    var c = e.getCustomData("list_marker_names"), d = e.getCustomData("list_marker_id"), f;
  ...
  (function () {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      isIdentical: function (a) {
        var f = this.clone(0, 1), a = a.clone(0, 1);
      ...
      isVisible: function () {
        var a = (this.$.offsetHeight || this.$.offsetWidth) && this.getComputedStyle("visibility") != "hidden", f, b;
      ...
      hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) ? function () {
        ...
        function () {
          var a = this.$.attributes, f = a.length, b = {"data-cke-expando": 1, _moz_dirty: 1};
          return f > 0 && (f > 2 || !b[a[0].nodeName] || f == 2 && !b[a[1].nodeName])
        },
      hasAttribute: function () {
        function a(d) {
          return (d = this.$.attributes.getNamedItem(d)) ? CKEDITOR.env.ie ? d.specified : true : false
        }
      ...
      mergeSiblings: function () {
        ...
        return function (f) {
          if (f === false || CKEDITOR.dtd.$removeEmpty[this.getName()] || this.is("a")) {
      ...
      removeStyle: function (a) {
        ...
        if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
          ...
          for (var b = [], i = 0; i < c.length; i++)if (e)for (var k = 0; k < e.length; k++)b.push([a, c[i], e[k]].join("-")); else b.push([a, c[i]].join("-"));
      ...
      getDocumentPosition: function (a) {
        var b = 0, c = 0, e = this.getDocument(), i = e.getBody(), k = e.$.compatMode == "BackCompat";
        if (document.documentElement.getBoundingClientRect) {
          var o = this.$.getBoundingClientRect(), s = e.$.documentElement, r = s.clientTop || i.$.clientTop || 0, v = s.clientLeft || i.$.clientLeft || 0, g = true;
          if (CKEDITOR.env.ie) {
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        function r(a, b) {
          ...
          f = a.getWindow();
          if (!f.equals(b)) {
            f = r(CKEDITOR.dom.element.get(f.$.frameElement), b);
            d.x = d.x + f.x;
            d.y = d.y + f.y
          }
          return d
        ...
        k = a.getWindow();
        i = r(this, k);
        var p = r(a, k), z = this.$.offsetHeight;
        e = this.$.offsetWidth;
        var A = a.$.clientHeight, l = a.$.clientWidth;
      ...
      copyAttributes: function (a, b) {
        for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
          var i = c[e], k = i.nodeName.toLowerCase(), o;
          if (!(k in b))if (k == "checked" && (o = this.getAttribute(k)))a.setAttribute(k, o);
          else if (!CKEDITOR.env.ie || this.hasAttribute(k)) {
      ...
      find: function (b) {
        var f = a(this), b = new CKEDITOR.dom.nodeList(this.$.querySelectorAll(e(this,
          b)));
        f();
        return b
      },
      findOne: function (b) {
        var f = a(this), b = this.$.querySelector(e(this, b));
        f();
  ...
  (function () {
    function a(a, b) {
      ...
      g = c.endContainer;
      var f = c.startOffset, e = c.endOffset, o, j = this.guard, m = this.type, u = a ? "getPreviousSourceNode" : "getNextSourceNode";
      if (!a && !this._.guardLTR) {
        var h = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(), q = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(e) : g.getNext();
        this._.guardLTR = function (a, b) {
          return (!b || !h.equals(a)) && (!q || !a.equals(q)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
        }
      }
      if (a && !this._.guardRTL) {
        var i = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), k = d.type == CKEDITOR.NODE_ELEMENT ? f ? d.getChild(f - 1) : null : d.getPrevious();
      ...
      if (this.current)g = this.current[u](false, m, o); else {
        if (a)g.type ==
        CKEDITOR.NODE_ELEMENT && (g = e > 0 ? g.getChild(e - 1) : o(g, true) === false ? null : g.getPreviousSourceNode(true, m, o)); else {
          g = d;
          if (g.type == CKEDITOR.NODE_ELEMENT && !(g = g.getChild(f)))g = o(d, true) === false ? null : d.getNextSourceNode(true, m, o)
        }
        g && o(g) === false && (g = null)
      }
      for (; g && !this._.end;) {
    ...
    var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.whitespaces(), n = CKEDITOR.dom.walker.bookmark(), i = CKEDITOR.dom.walker.temp();
  ...
  (function () {
    ...
    var c = function (a) {
      ...
      a.optimizeBookmark();
      var g = a.startContainer, f = a.endContainer, e = a.startOffset, h = a.endOffset, l, j;
      if (f.type == CKEDITOR.NODE_TEXT)f = f.split(h);
      else if (f.getChildCount() > 0)if (h >= f.getChildCount()) {
      ...
      var e = g.getParents(), h = f.getParents(), m, u, i;
      ...
      for (var q = c, k, H, n, C = m; C < e.length; C++) {
        ...
        for (k = k.getNext(); k;) {
          ...
          n = k.getNext();
          if (b == 2)q.append(k.clone(true)); else {
            k.remove();
            b == 1 && q.append(k)
          }
          k = n
      ...
      for (c = m; c < h.length; c++) {
        ...
        if (!e[c] || k.$.parentNode != e[c].$.parentNode)for (k = k.getPrevious(); k;) {
          if (k.equals(e[c]) || k.equals(g))break;
          n = k.getPrevious();
          if (b == 2)q.$.insertBefore(k.$.cloneNode(true), q.$.firstChild); else {
            k.remove();
      ...
      u: 1,
      "var": 1
    }, h = CKEDITOR.dom.walker.bogus(), n = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, i = CKEDITOR.dom.walker.editable(), k = CKEDITOR.dom.walker.ignored(true);
    CKEDITOR.dom.range.prototype =
    {
      ...
      function a(b) {
        ...
        if (c.type == CKEDITOR.NODE_TEXT) {
          g = c;
          for (f = 0; (g = g.getPrevious()) && g.type == CKEDITOR.NODE_TEXT;)f = f + g.getLength();
          d = d + f
        }
        b.container = c;
        b.offset = d
      ...
      switch (a) {
        ...
        case CKEDITOR.ENLARGE_ELEMENT:
          ...
          var f = this.getCommonAncestor(), e = this.root, k, l, j, m, u, h = false, q, i;
          ...
          for (j = c(j); j || m;) {
            ...
            for (; m;) {
              q = false;
              if (m.type == CKEDITOR.NODE_COMMENT)m = m.getPrevious(); else {
                if (m.type == CKEDITOR.NODE_TEXT) {
                  i = m.getText();
                  d.test(i) && (m = null);
                  q = /[\s\ufeff]$/.test(i)
                } else if ((m.$.offsetWidth >
                  0 || b && m.is("br")) && !m.data("cke-bookmark"))if (h && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                  i = m.getText();
                  if (d.test(i))m = null; else for (var n = m.$.getElementsByTagName("*"), G = 0, C; C = n[G++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                    m = null;
                    break
                  }
                  m && (q = !!i.length)
          ...
          if (q.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.tools.trim(q.substring(n)).length)h = true; else {
            h = !q.getLength();
            if (n == q.getLength()) {
              if (!(m = q.getNext()))j = q.getParent()
            } else J(q,
              n) && (j = q.getParent())
          ...
          for (; j || m;) {
            ...
            for (; m;) {
              ...
              if (m.type == CKEDITOR.NODE_TEXT) {
                ...
                if ((m.$.offsetWidth > 0 || b && m.is("br")) && !m.data("cke-bookmark"))if (h && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                  i = m.getText();
                  if (d.test(i))m = null; else {
                    n = m.$.getElementsByTagName("*");
                    for (G = 0; C = n[G++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                      m = null;
                      break
                    }
                  }
        ...
        case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
          ...
          var F, t, x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), y = null, B = function (a) {
            if (a.type == CKEDITOR.NODE_ELEMENT && a.getAttribute("contenteditable") == "false")if (y) {
              if (y.equals(a)) {
                y = null;
                return
              }
            } else y = a; else if (y)return;
            var b = x(a);
            b || (F = a);
            return b
          }, g = function (a) {
          ...
          if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
            j = this.clone();
            j = new CKEDITOR.dom.walker(j);
            var w = CKEDITOR.dom.walker.whitespaces(), N = CKEDITOR.dom.walker.bookmark();
      ...
      if (!this.collapsed) {
        var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), g = this.startContainer, f = this.endContainer, e = this.startOffset, h = this.endOffset, l = 1, j = 1;
        if (g && g.type == CKEDITOR.NODE_TEXT)if (e)if (e >= g.getLength())d.setStartAfter(g); else {
          d.setStartBefore(g);
          l = 0
        ...
        var d = new CKEDITOR.dom.walker(d), m = CKEDITOR.dom.walker.bookmark();
      ...
      var c = new CKEDITOR.dom.range(this.root), d = 0, g, f = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        for (this._.nextNode = null; p;) {
          var z = 0, A = p.hasAscendant("pre"), l = p.type != CKEDITOR.NODE_ELEMENT, j = 0;
          if (l)p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (l = 0); else {
            var m = p.getName();
            if (CKEDITOR.dtd.$block[m] && p.getAttribute("contenteditable") == "false") {
              b = p;
              c(this, a, b);
              break
            } else if (p.isBlockBoundary(this.forceBrBreak && !A && {br: 1})) {
              if (m == "br")l = 1; else if (!h && !p.getChildCount() &&
                m != "hr") {
                b = p;
                s = p.equals(g);
                break
        ...
        if (!b) {
          ...
          z = {div: 1, th: 1, td: 1};
          b = b.block;
          if (!b && p && !this.enforceRealBlocks && z[p.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !p.equals(h.root))b = p; else if (!b || this.enforceRealBlocks && b.getName() == "li") {
  ...
  (function () {
    function a(a, b, c, d, g) {
      ...
      for (f in b) {
        ...
        for (p in y) {
          j[p] = h(j[p], l) || null;
          var m = j, q = B[p], w = h(j[B[p]], l), u = j[p], t = [], i = true, k = void 0;
          w ? i = false : w = {};
          for (k in u)if (k.charAt(0) == "!") {
            k = k.slice(1);
            t.push(k);
            w[k] = true;
            i = false
      ...
      for (var b = g.elements, g = g.generic, z, c = 0, d = a.length; c < d; ++c) {
        ...
        for (p in B) {
          ...
          w = [];
          u = void 0;
          for (u in q)u.indexOf("*") > -1 ? w.push(RegExp("^" + u.replace(/\*/g, ".*") + "$")) : w.push(u);
          q = w;
          if (q.length) {
            j[l] = q;
            m = false
        ...
        if (f.elements === true || f.elements === null)g[e ? "unshift" : "push"](f); else {
          j = f.elements;
          delete f.elements;
          for (z in j)if (b[z])b[z][e ? "unshift" : "push"](f); else b[z] = [f]
        }
      }
    }
    ...
    function v(a, b, d, g) {
      ...
      if (g.doCallbacks && a.elementCallbacks) {
        a:for (var l = a.elementCallbacks, m = 0, h = l.length, q; m < h; ++m)if (q = l[m](b)) {
          j = q;
          break a
        }
        if (j)return j
      }
      if (g.doTransform)if (j = a._.transformations[b.name]) {
        r(b);
        for (l = 0; l < j.length; ++l)u(a, b, j[l]);
        p(b)
      }
      if (g.doFilter) {
        a:{
          ...
          if (!a && !j)a = null; else {
            ...
            if (l) {
              w = 0;
              for (t = l.length; w < t; ++w)if (c(l[w], b, q) === false) {
                a = null;
                break a
              }
            }
            if (m) {
              w = 0;
              for (t = m.length; w < t; ++w)c(m[w], b, q)
            }
            if (a) {
              w = 0;
              for (t = a.length; w <
            ...
            if (j) {
              w = 0;
              for (t = j.length; w < t; ++w)e(j[w], b, q, h)
            }
            a = q
          }
        }
        ...
        var i = a.validStyles;
        j = a.validClasses;
        var l = b.attributes, k = b.styles, m = b.classes, h = b.classBackup, B = b.styleBackup, y, x, N = [];
        q = [];
        var n = /^data-cke-/;
        w = false;
        delete l.style;
        ...
        if (!a.allAttributes)for (y in l)if (!t[y])if (n.test(y)) {
        ...
        if (!a.allClasses || a.hadInvalidClass) {
          for (y = 0; y < m.length; ++y)(a.allClasses || j[m[y]]) && q.push(m[y]);
          q.length && (l["class"] = q.sort().join(" "));
          h && q.length < h.split(/\s+/).length && (w = true)
        } else h && (l["class"] = h);
        w && (f = C);
    ...
    function m(a, b, c) {
      var d = a.name;
      if (G.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(l()); else {
        a.parent && c.push({check: "it", el: a.parent});
        a.remove()
      } else if (G.$block[d] || d == "tr")if (b == "br") {
        ...
        b:{
          ...
          for (var f = 0, e = d.length, m; f < e; ++f) {
            m = d[f];
            if (m.type == CKEDITOR.NODE_ELEMENT && !g[m.name]) {
              g = false;
              break b
            }
          }
        ...
        if (g) {
          ...
          for (var f = g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g.name == "body", p, e = d.length; e > 0;) {
            m = d[--e];
            if (f && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && G.$inline[m.name])) {
              if (!p) {
              ...
              p =
                null;
              m.insertAfter(a);
              g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (m.type == CKEDITOR.NODE_ELEMENT && !G[g.name][m.name]) && c.push({
                check: "el-up",
                el: m
              })
            }
    ...
    function P(a, b) {
      var c = b.getDefinition(), d = c.attributes, g = c.styles, f, e, j, l;
      if (a.name != c.element)return false;
      for (f in d)if (f == "class") {
        c = d[f].split(/\s+/);
        for (j = a.classes.join("|"); l = c.pop();)if (j.indexOf(l) == -1)return false
    ...
    var G = CKEDITOR.dtd,
      C = 1, J = CKEDITOR.tools.copy, F = CKEDITOR.tools.trim, t = "cke-test", x = ["", "p", "br", "div"];
    ...
    CKEDITOR.filter.prototype = {
      allow: function (b, c, d) {
        ...
        if (typeof b == "string")b = o(b);
          ...
          b = {};
          d = g.attributes;
          b[g.element] = g = {styles: g.styles, requiredStyles: g.styles && CKEDITOR.tools.objectKeys(g.styles)};
          if (d) {
            d = J(d);
        ...
        var g = this, f = [], e = this.editor && this.editor.config.protectedSource, j, l = false, p = {
          doFilter: !c,
          doTransform: true,
          doCallbacks: true,
          toHtml: b
        ...
        a.forEach(function (a) {
          if (a.type == CKEDITOR.NODE_ELEMENT) {
            ...
            a:{
              ...
              c = [];
              var m, q, w;
              if (e)for (q = 0; q < e.length; ++q)if ((w = d.match(e[q])) && w[0].length == d.length) {
                c = true;
                break a
              }
              d = CKEDITOR.htmlParser.fragment.fromHtml(d);
              d.children.length == 1 && (m = d.children[0]).type == CKEDITOR.NODE_ELEMENT && v(g, m, c, p);
              c = !c.length
            }
            c || f.push(a)
          }
        ...
        for (; q = a.pop();) {
          c = q.el;
          if (c.parent)switch (q.check) {
            case "it":
              G.$removeEmpty[c.name] && !c.children.length ? m(c, d, a) : z(c) || m(c, d, a);
              break;
            case "el-up":
              c.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !G[c.parent.name][c.name] && m(c, d, a);
              break;
            case "parent-down":
        ...
        if (!this.disabled && a) {
          ...
          for (g = 0; g < a.length; ++g) {
            b = a[g];
            var f = void 0, e = void 0, j = void 0, l = void 0, m = void 0, p = void 0;
            c = [];
      ...
      check: function (a, b, c) {
        ...
        var e = CKEDITOR.tools.clone(g), j = [], l;
        if (b !== false && (l = this._.transformations[g.name])) {
          for (d = 0; d < l.length; ++d)u(this, g, l[d]);
          p(g)
        }
    ...
    var y = {styles: 1, attributes: 1, classes: 1}, B = {
    ...
    }, w = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, N = {
      styles: /{([^}]+)}/,
      attrs: /\[([^\]]+)\]/,
      classes: /\(([^\)]+)\)/
    }, M = /^cke:(object|embed|param)$/, D = /^(object|embed|param)$/, ba = CKEDITOR.filter.transformationsTools = {
      ...
      }, matchesStyle: P, transform: function (a, b) {
        if (typeof b == "string")a.name = b; else {
          var c = b.getDefinition(), d = c.styles, g = c.attributes, f, e, j, l;
          a.name = c.element;
          for (f in g)if (f == "class") {
            c = a.classes.join("|");
            for (j = g[f].split(/\s+/); l = j.pop();)c.indexOf(l) == -1 && a.classes.push(l)
  ...
  (function () {
    var a, e = function (b) {
      var b = b.data, d = b.getKeystroke(), f = this.keystrokes[d], e = this._.editor;
      a = e.fire("key", {keyCode: d, domEvent: b}) === false;
      if (!a) {
        f && (a = e.execCommand(f, {from: "keystrokeHandler"}) !== false);
  ...
  CKEDITOR.scriptLoader = function () {
    ...
    return {
      load: function (b, c, d, f) {
        ...
        h && (b = [b]);
        d || (d = CKEDITOR);
        var n = b.length, i = [], k = [], o = function (a) {
    ...
    return function (b, c, d) {
      var f = {}, h = function (b) {
        a.call(this, b, function (a) {
          ...
          var b = [], n;
          for (n in a) {
            var s = a[n], r = s && s.requires;
            if (!e[n]) {
              if (s.icons)for (var v = s.icons.split(","), g = v.length; g--;)CKEDITOR.skin.addIcon(v[g], s.path + "icons/" + (CKEDITOR.env.hidpi && s.hidpi ? "hidpi/" : "") + v[g] + ".png");
              e[n] = 1
            }
            if (r) {
              r.split && (r = r.split(","));
              for (s = 0; s < r.length; s++)f[r[s]] || b.push(r[s])
            }
          }
  ...
  (function () {
    ...
    function o(a) {
      ...
      if (f)var m = RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(m, "");
      CKEDITOR.env.air &&
      (c = c + ",adobeair");
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        a.plugins = c;
        for (var j in c) {
          var l = c[j], h = l.lang, i = null, k = l.requires, t;
          CKEDITOR.tools.isArray(k) && (k = k.join(","));
          if (k && (t = k.match(m)))for (; k = t.pop();)CKEDITOR.tools.setTimeout(function (a, b) {
          ...
          if (h && !a.lang[j]) {
            ...
            if (!l.langEntries || !l.langEntries[i])e.push(CKEDITOR.getUrl(l.path + "lang/" + i + ".js")); else {
              a.lang[j] = l.langEntries[i];
              i = null
            }
          }
          f.push(i);
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml =
      function (f, h, n) {
        function i(a) {
          var b;
          if (z.length > 0)for (var c = 0; c < z.length; c++) {
            var d = z[c], f = d.name, e = CKEDITOR.dtd[f], g = l.name && CKEDITOR.dtd[l.name];
        ...
        var g = new CKEDITOR.htmlParser, p = h instanceof CKEDITOR.htmlParser.element ? h : typeof h == "string" ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, z = [], A = [], l = p, j = p.name == "textarea", m = p.name == "pre";
        g.onTagOpen = function (d, f, h, p) {
          f = new CKEDITOR.htmlParser.element(d, f);
          if (f.isUnknown && h)f.isEmpty =
            true;
          f.isOptionalClose = p;
          if (a(f))z.push(f); else {
            if (d == "pre")m = true; else {
              if (d == "br" && m) {
            ...
            if (d == "br")A.push(f); else {
              for (; ;) {
                p = (h = l.name) ? CKEDITOR.dtd[h] || (l._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!f.isUnknown && !l.isUnknown && !p[d])if (l.isOptionalClose)g.onTagClose(h); else if (d in b && h in b) {
                  h = l.children;
                  (h = h[h.length - 1]) && h.name == "li" || s(h = new CKEDITOR.htmlParser.element("li"), l);
                  !f.returnPoint && (f.returnPoint = l);
                  l = h
                } else if (d in CKEDITOR.dtd.$listItem && !v(d, h))g.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1); else if (h in e && !v(d, h)) {
                  !f.returnPoint && (f.returnPoint = l);
                  l = l.parent
                } else {
                  h in CKEDITOR.dtd.$inline && z.unshift(l);
                  if (l.parent)s(l, l.parent, 1); else {
                    f.isOrphan = 1;
                    break
                  }
                } else break
        ...
        g.onTagClose = function (a) {
          for (var b = z.length - 1; b >= 0; b--)if (a == z[b].name) {
            z.splice(b, 1);
            return
          }
          for (var c = [], d = [], f = l; f != p && f.name != a;) {
        ...
        g.onText = function (a) {
          if ((!l._.hasInlineStarted || A.length) && !m && !j) {
            a = CKEDITOR.tools.ltrim(a);
            if (a.length === 0)return
          }
          var b = l.name, f = b ? CKEDITOR.dtd[b] || (l._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
          if (!j && !f["#"] && b in e) {
            g.onTagOpen(d[b] || "");
            g.onText(a)
          } else {
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
      $: function (b) {
        ...
        addRules: function (a, c) {
          ...
          for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], f, e = 0; e < 3; e++)if (f = d[e]) {
            f = f.exec(a, c, this);
    ...
    a.prototype = {
      add: function (a, c, d) {
        ...
        var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, f = Array.prototype.slice.call(arguments, 1), e = this.rules, n = e.length, i, k, o, s;
        for (s = 0; s < n; s++) {
          if (d) {
            i = c.type;
            k = c.name
  ...
  (function () {
    function a(a, e) {
      ...
      function j(a, d) {
        return function (e) {
          if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var j = [], l = b(e), m, w;
            if (l)for (t(l, 1) && j.push(l); l;) {
              if (f(l) && (m = c(l)) && t(m))if ((w = c(m)) && !f(w))j.push(m); else {
                g(p).insertAfter(m);
                m.remove()
              }
              l = l.previous
            ...
            if (j = typeof d == "function" ? d(e) !== false : d)if (!p && !CKEDITOR.env.needsBrFiller &&
              e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)j = false; else if (!p && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem))j = false; else {
              j = b(e);
      ...
      function t(a, b) {
        ...
        if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(z))) {
          ...
          if (!p)if ((c = a.previous) && c.name == "br" || !c || f(c))return true
        }
        return false
      }

      var q = {elements: {}}, p = e == "html", i = CKEDITOR.tools.extend({}, m), u;
    ...
    function p(a, b) {
      for (var c = [], d = b.config.protectedSource, f = b._.dataStore || (b._.dataStore =
        {id: 1}), e = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g, function (a) {
    ...
    var z = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", l = CKEDITOR.dtd, j = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], m = CKEDITOR.tools.extend({}, l.$blockLimit, l.$block), u = {
      elements: {
        input: n,
        textarea: n
      }
    }, P = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, q = {
      elements: {
        embed: function (a) {
          var b = a.parent;
          if (b && b.name == "object") {
    ...
    var H = /<(a|area|img|input|source)\b([^>]*)>/gi, G = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /^(href|src|name)$/i, J = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, F = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, t = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, x = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, y = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, B = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
  })();
  "use strict";
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
      type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
        ...
        var f = this, e, n, b = f.getFilterContext(b);
        ...
        for (i in e) {
          k = i;
          for (n = e[i]; ;)if (k = a.onAttributeName(b, i))if (k != i) {
            delete e[i];
            i = k
          } else break; else {
            delete e[i];
        ...
        b && this.filter(b);
        var f = this.name, h = [], n = this.attributes, i, k;
        a.openTag(f, n);
        ...
        if (b.length)for (var a = CKEDITOR.tools.copy(a), f = 0; f < b.length; f = f + 2)a[b[f]] = b[f + 1];
        return a
      }
    }, true)
  })();
  ...
  (function () {
    ...
    CKEDITOR.inlineAll = function () {
      var a, e, b;
      for (b in CKEDITOR.dtd.$editable)for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, f = c.count(); d < f; d++) {
        a = c.getItem(d);
        if (a.getAttribute("contenteditable") == "true") {
          e = {element: a, config: {}};
  ...
  (function () {
    ...
    CKEDITOR.editor.prototype.setMode =
      function (a, b) {
        ...
        if (!(a == c.mode || !e || !e[a])) {
          ...
          if (c.mode) {
            var i = c.checkDirty(), e = c._.previousModeData, k, o = 0;
    ...
    CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
      var i = this.container, k = this.ui.space("contents"), o = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, e = e ? i.getChild(1) : i;
  ...
  (function () {
    function a(a) {
      var b = a.editor, d = a.data.path, f = d.blockLimit, l = a.data.selection, j = l.getRanges()[0], m;
    ...
    CKEDITOR.editable = CKEDITOR.tools.createClass({
      base: CKEDITOR.dom.element, $: function (a, b) {
        ...
        focus: function () {
          ...
          var m = Array.prototype.slice.call(arguments, 1), m = a.on.apply(a, m);
        ...
        changeAttr: function (a, b) {
          ...
          if (!b) {
            var e = /\n{2}/g;
            if (e.test(a))var f = "<" + c + ">", m = "</" + c + ">", a = f + a.replace(e, function () {
                return m + f
              }) + m
          }
          a = a.replace(/\n/g, "<br>");
          ...
          var m, h;
          if (f)for (; (m = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[m.getName()]) && (!h || !h[e]);)if (m.getName()in CKEDITOR.dtd.span)b.splitElement(m); else if (b.checkStartOfBlock() && b.checkEndOfBlock()) {
            b.setStartBefore(m);
            b.collapse(true);
            m.remove()
          } else b.splitBlock(d ==
          ...
          if (!this.is("textarea")) {
            ...
            this.attachListener(a, "key", function (b) {
              ...
              if (c in l) {
                var b = a.getSelection(), e, q = b.getRanges()[0], h = q.startPath(), i, k, p, c = c == 8;
                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (e = b.getSelectedElement()) || (e = f(b))) {
                  ...
                  a.fire("saveSnapshot");
                  d = 1
                } else if (q.collapsed)if ((i = h.block) && (p = i[c ? "getPrevious" : "getNext"](o)) && p.type == CKEDITOR.NODE_ELEMENT &&
                  p.is("table") && q[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) {
                  a.fire("saveSnapshot");
                  ...
                  a.fire("saveSnapshot");
                  d = 1
                } else if (h.blockLimit && h.blockLimit.is("td") && (k = h.blockLimit.getAscendant("table")) && q.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END) && (p = k[c ? "getPrevious" : "getNext"](o))) {
                  a.fire("saveSnapshot");
                  q["moveToElementEdit" + (c ? "End" : "Start")](p);
            ...
            CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
              ...
              if (b in l) {
                var b = b == 8, c = a.getSelection(), d = c.getRanges()[0], e = d.startPath(), f = e.block;
                if (d.collapsed &&
                  ...
                  if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) {
                    var h = d.startContainer.getChild(d.startOffset - (b ? 1 : 0));
                  ...
                  if ((d = d.startPath().block) && (!d || !d.contains(f))) {
                    a.fire("saveSnapshot");
                    for (var i = f.getCommonAncestor(d), k = b ? f : d, h = k; (k = k.getParent()) && !i.equals(k) && k.getChildCount() == 1;)h = k;
                    var p;
    ...
    var i = CKEDITOR.dom.walker.bogus(), k = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
      o = CKEDITOR.dom.walker.whitespaces(true), s = CKEDITOR.dom.walker.bookmark(false, true);
      ...
      b.on("mode", function () {
        ...
        if (a && a.isInline()) {
          ...
          if (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" : "contents")) {
            var d = CKEDITOR.tools.getNextId(), e = CKEDITOR.dom.element.createFromHtml('<span id="' + d + '" class="cke_voice_label">' + this.lang.common.editorHelp +
              "</span>");
            c.append(e);
    ...
    var r = function () {
      ...
      function b(c, d) {
        var e, f, j, l, t = [], q = d.range.startContainer;
        e = d.range.startPath();
      ...
      function d(b, c) {
        var e = [], f = b.getChildren(), j = f.count(), l, t = 0, q = m[c], h = !b.is(m.$inline) ||
          b.is("br");
        for (h && e.push(" "); t < j; t++) {
          l = f.getItem(t);
      ...
      var m = CKEDITOR.dtd, h = {
        ...
        dl: 1,
        blockquote: 1
      }, k = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, q = CKEDITOR.tools.extend({}, m.$inline);
      delete q.br;
      return function (h,
                       i, u) {
        var o = h.editor;
        h.getDocument();
        var s = o.getSelection().getRanges()[0], r = false;
        if (i == "unfiltered_html") {
          i = "html";
          r = true
        }
        if (!s.checkReadOnly()) {
          var t = (new CKEDITOR.dom.elementPath(s.startContainer, s.root)).blockLimit || s.root, i = {
            type: i,
            dontFilter: r,
            editable: h,
            editor: o,
            ...
            mergeCandidates: [],
            zombies: []
          }, o = i.range, r = i.mergeCandidates, x, y, B, w;
          ...
          if (!o.collapsed) {
            var t = B.block || B.blockLimit, N = o.getCommonAncestor();
            t && (!t.equals(N) && !t.contains(N) && o.checkEndOfBlock()) && i.zombies.push(t);
            o.deleteContents()
          }
          for (; (w = a(o.startContainer) && o.startContainer.getChild(o.startOffset - 1)) && a(w) && w.isBlockBoundary() && y.contains(w);)o.moveToPosition(w, CKEDITOR.POSITION_BEFORE_END);
          ...
          for (t = x.startNode; (t = t.getParent()) && e(t);)r.push(t);
          o.moveToBookmark(x);
          if (x = u) {
            x = i.range;
            ...
            if (/^\s+|\s+$/.test(u) && "span"in CKEDITOR.dtd[w])var M = '<span data-cke-marker="1">&nbsp;</span>', u = M + u + M;
            u = i.editor.dataProcessor.toHtml(u, {
              context: null,
              fixForBody: false,
          ...
          if (x) {
            D = i.range;
            var M = D.document, v, u = i.blockLimit;
            x = 0;
            var I;
            w = [];
            var E, Q, r = o = 0, K, S;
            y = D.startContainer;
            var t = i.endPath.elements[0], T;
            B = t.getPosition(y);
            ...
            for (j(y, D); x < y.length; x++) {
              ...
              if (v = B.isLineBreak) {
                ...
                if (B.hasBlockSibling)v = 1; else {
                  O = v.startContainer.getAscendant(m.$block, 1);
                  if (!O || !O.is({div: 1, p: 1}))v = 0; else {
                    W = O.getPosition(K);
                    if (W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS)v = 0; else {
                      K = v.splitElement(O);
              ...
              if (v)r = x > 0; else {
                v = D.startPath();
                if (!B.isBlock && i.editor.config.autoParagraph !== false && (i.editor.activeEnterMode != CKEDITOR.ENTER_BR && i.editor.editable().equals(v.blockLimit) && !v.block) && (Q = i.editor.activeEnterMode != CKEDITOR.ENTER_BR && i.editor.config.autoParagraph !== false ? i.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : false)) {
                  Q = M.createElement(Q);
                  Q.appendBogus();
                  D.insertNode(Q);
                ...
                if ((v = D.startPath().block) && !v.equals(E)) {
                  if (I = v.getBogus()) {
                    I.remove();
                    w.push(v)
                  }
          ...
          for (T = I.createBookmark(); E = i.zombies.pop();)if (E.getParent()) {
            Q = I.clone();
            Q.moveToElementEditStart(E);
            Q.removeEmptyBlocksAtEnd()
          }
          if (S)for (; E = S.pop();)CKEDITOR.env.needsBrFiller ? E.appendBogus() : E.append(I.document.createText(" "));
      ...
      return function (d) {
        var e = d.startContainer, f = e.getAscendant("table", 1), m = false;
        ...
        if (f.is("table")) {
          ...
          f.is({tbody: 1, thead: 1, tfoot: 1}) && (f = b(f, "tr", m));
  ...
  (function () {
    ...
    function c(a) {
      ...
      var c = a.startContainer, d = a.getPreviousNode(v, null, c), e = a.getNextNode(v, null, c);
    ...
    var s, r, v = CKEDITOR.dom.walker.invisible(1), g = function () {
      function a(b) {
        return function (a) {
    ...
    CKEDITOR.on("instanceCreated", function (b) {
      ...
      d.on("contentDom", function () {
        var b = d.document, c = CKEDITOR.document, g = d.editable(), j = b.getBody(), l = b.getDocumentElement(), h = g.isInline(), i, o;
        CKEDITOR.env.gecko && g.attachListener(g, "focus", function (a) {
            a.removeListener();
            if (i !== 0)if ((a = d.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$) {
              a = d.createRange();
    ...
    var p =
      typeof window.getSelection != "function", z = 1;
    CKEDITOR.dom.selection = function (a) {
      ...
      if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && n(a, b); else if (CKEDITOR.env.gecko)b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && n(a, b, true); else if (CKEDITOR.env.ie) {
        ...
        if (p)b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && n(a, null, true); else {
          ...
          var b = function (b, c) {
            ...
            for (var e = d.children, f, g, h = b.duplicate(), i = 0, l = e.length - 1, t = -1, m, k; i <= l;) {
              ...
              m = h.compareEndPoints("StartToStart",
                b);
              if (m > 0)l = t - 1; else if (m < 0)i = t + 1; else return {container: d, offset: a(f)}
            }
            if (t == -1 || t == e.length - 1 && m < 0) {
              ...
              if (!h) {
                f = e[e.length - 1];
                return f.nodeType != CKEDITOR.NODE_TEXT ? {container: d, offset: e.length} : {
                  container: f,
            ...
            for (; h > 0;)try {
              g = f[m > 0 ? "previousSibling" : "nextSibling"];
              if (g.nodeType == CKEDITOR.NODE_TEXT) {
                h = h - g.nodeValue.length;
                k = g
              }
        ...
        if (a.length)if (this.isLocked) {
          ...
          if (h)this.fake(h); else {
            if (p) {
              ...
              (h.startContainer.type == CKEDITOR.NODE_ELEMENT && h.startContainer.getName()in b || h.endContainer.type == CKEDITOR.NODE_ELEMENT && h.endContainer.getName()in b) && h.shrink(CKEDITOR.NODE_ELEMENT, true);
              r = h.createBookmark();
              b = r.startNode;
              if (!a)g = r.endNode;
  ...
  (function () {
    ...
    function e(b) {
      ...
      if (b.collapsed) {
        ...
        b.trim();
        var o = b.createBookmark(), m = o.startNode, l = o.endNode, n = m, p;
        if (!i) {
          var r = b.getCommonAncestor(), i = a(m, r), r = a(l, r);
        ...
        for (n.getPosition(l) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
          ...
          if (n.equals(l)) {
            ...
            var q = n.type == CKEDITOR.NODE_ELEMENT ? n.getName() : null, r = q && n.getAttribute("contentEditable") == "false", s = q && n.getAttribute("data-nostyle");
            if (q && n.data("cke-bookmark")) {
              n =
                n.getNextSourceNode(true);
              continue
            }
            if (r && k && CKEDITOR.dtd.$block[q])for (var u = n, A = c(u), C = void 0, H = A.length, P = 0, u = H && new CKEDITOR.dom.range(u.getDocument()); P < H; ++P) {
              var C = A[P], U = CKEDITOR.filter.instances[C.data("cke-filter")];
              if (U ? U.check(this) : 1) {
            ...
            if (A)if ((A = n.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(A))) {
              ...
              q = n.type;
              if (q == CKEDITOR.NODE_TEXT || r || q == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                for (var q = n, L; (i = !q.getNext(G)) && (L = q.getParent(), j[L.getName()]) && (L.getPosition(m) | F) == F && (!g.childRule || g.childRule(L));)q = L;
                p.setEndAfter(q)
              }
          ...
          if (i && p && !p.collapsed) {
            for (var i = z(this, d), r = i.hasAttributes(), s = p.getCommonAncestor(), q = {}, A = {}, C = {}, H = {}, V, R, Y; i && s;) {
              if (s.getName() == f) {
                ...
                for (R in g.styles)if (!C[R] && (Y = s.getStyle(R)))i.getStyle(R) == Y ? q[R] = 1 : C[R] = 1
              }
              s = s.getParent()
            }
    ...
    function r(a, b) {
      var c = this._.definition,
        d = c.attributes, c = c.styles, e = j(this)[a.getName()], f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), h;
      for (h in d)if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != m(h, d[h])) && !(b && h.slice(0, 5) == "data-")) {
        f = a.hasAttribute(h);
        a.removeAttribute(h)
      }
      for (var i in c)if (!(this._.definition.fullMatch && a.getStyle(i) != m(i, c[i], true))) {
        f = f || !!a.getStyle(i);
        a.removeStyle(i)
      }
      g(a, e, P[a.getName()]);
    ...
    }, q =
    {
      ...
      audio: 1,
      video: 1
    }, L = /\s*(?:;\s*|$)/, H = /#\((.+?)\)/g, G = CKEDITOR.dom.walker.bookmark(0, 1), C = CKEDITOR.dom.walker.whitespaces(1);
      ...
      if (!b) {
        ...
        this.on("selectionChange", function (a) {
          for (var d = 0; d < b.length; d++) {
            var e = b[d], h = e.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
            e.fn.call(this, h)
          }
        })
      }
  ...
  (function () {
    ...
    CKEDITOR.dom.elementPath = function (b, d) {
      var f = null, h = null, n = [], i = b, k, d = d || b.getDocument().getBody();
  ...
  CKEDITOR.dom.elementPath.prototype = {
    compare: function (a) {
      ...
      var d = this.elements, f = d.length;
      e && f--;
      if (b) {
        d = Array.prototype.slice.call(d, 0);
        d.reverse()
      }
      for (e = 0; e < f; e++)if (c(d[e]))return d[e];
      return null
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
    type: CKEDITOR.NODE_TEXT, getLength: function () {
      ...
      var e = this.$.parentNode, b = e.childNodes.length, c = this.getLength(), d = this.getDocument(), f = new CKEDITOR.dom.text(this.$.splitText(a), d);
  ...
  (function () {
    function a(a, c, d) {
      var e = a.serializable, h = c[d ? "endContainer" : "startContainer"], n = d ? "endOffset" : "startOffset", i = e ? c.document.getById(a.startNode) : a.startNode, a = e ? c.document.getById(a.endNode) : a.endNode;
            ...
            if (n && a.length > 1) {
              ...
              if (h)for (var k = 0; a[e + k + 1];) {
                ...
                1].startNode); ;) {
                  ...
                  if (o.equals(i))h = 1; else if (c(i) || i.type == CKEDITOR.NODE_ELEMENT && i.isBlockBoundary())continue;
                  break
                }
                if (!h)break;
                k++
  ...
  (function () {
    ...
    var h = "cke_ui_color", n = [], i = /\$color/g;
      ...
      $: function (a) {
        ...
        setData: function (a, d) {
          ...
          if (d)this.setHtml(a), b.fire("dataReady"); else {
            ...
            e &&
            (a = a.replace(/<!DOCTYPE[^>]*>/i, function (a) {
              b.docType = g = a;
              return ""
